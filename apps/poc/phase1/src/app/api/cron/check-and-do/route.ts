...
・**時価総額の大きい外資系企業を優先的に調査**し、複数の企業について充足性を判定すること
・出力フォーマットは以下の参考例に従うこと：https://chatgpt.com/share/6888b4c6-0cf0-8006-9184-df70dcf05384

▼出力フォーマット（企業ごとにテーブルを作成）：

## 企業名1（例：Microsoft - 製品名：Azure IoT等）
