...
これまで手動でChatGPTにプロンプトエンジニアリングを用いて実施していた侵害調査および買収後の収益性調査を、LLMパイプライン + FastAPIで自動化するためのワークフロー設計です。
...
| **②侵害調査** | 手動でプロンプト作成、ChatGPTへコピペ実行 | AIエージェントが自動分析、Web検索で製品仕様を自動収集 | Phase 2 で実装中 |
